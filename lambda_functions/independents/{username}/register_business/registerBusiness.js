...
exports.handler = async (event, context) => {
  ...
  const params = {
    ...
    Key: { username },
    UpdateExpression:
      "SET #bn = :bn, #pc = :pc, #ad = :ad, #bt = :bt, #cu = :cu, #ve = :ve, #vg = :vg, #ha = :ha, #gf = :gf, #lu = :lu, #ab = :ab, #ta = :ta, #la = :la, #lo = :lo, #ba = :ba, #me = :me, #up = :up, #pn = :pn, #fb = :fb, #tw = :tw, #ig = :ig, #hb = :hb, #vf = :vf, #co = :co, #vo = :vo",
